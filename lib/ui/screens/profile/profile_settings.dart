...
Widget _buttonProfilePicture(context, Grihini grihini) {
  return MaterialButton(
    onPressed: () {
      Navigator.pushNamed(context, photoUploadScreenRoute,arguments: ["users/${grihini.uid}/profilePicture",true,grihini]);
    },
    child: Ink(
      width: w * 0.7,
...
Widget _buttonCitizenshipProof(context, Grihini grihini) {
  return MaterialButton(
    onPressed: () {
      Navigator.pushNamed(context, photoUploadScreenRoute,arguments: ["users/${grihini.uid}/citizenshipProof",false,grihini]);
    },
    child: Ink(
      width: w * 0.7,
      decoration: BoxDecoration(
...
Widget _buttonOtherPhotoes(context, Grihini grihini) {
  return MaterialButton(
    onPressed: () {
      Navigator.pushNamed(context, photoUploadScreenRoute,arguments: ["users/${grihini.uid}/otherPhoto",false,grihini]);
    },
    child: Ink(
      width: w * 0.7,
      decoration: BoxDecoration(
...
Future<void> _displayTextInputDialog(BuildContext context,Grihini grihini) async {
